...
apiRouter.get("/unidades-list", AlunoController.adicionar);
apiRouter.post("/unidades", AlunoController.adicionar);
apiRouter.put("/unidades/:id", AlunoController.editar);
apiRouter.delete("/unidades/:id", AlunoController.remover);
